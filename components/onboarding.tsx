    ...
    <div className="fixed inset-0 z-50 grid overflow-y-auto bg-background/95 p-4 backdrop-blur-sm sm:p-8">
      <form onSubmit={submit} className="m-auto w-full max-w-2xl rounded-3xl border border-border bg-card p-6 shadow-2xl sm:p-9">
        <div className="mb-7 flex items-center gap-3">
          ...
          <div><p className="text-sm font-bold text-primary">MindSathi</p><h1 className="text-2xl font-extrabold">Let’s make this personal 👋</h1></div>
        </div>
        ...
        <button className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-5 py-4 font-extrabold text-primary-foreground">Create my MindSathi <ArrowRight className="size-5" /></button>
      </form>
    </div>
  )
}
